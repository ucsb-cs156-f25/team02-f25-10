...
public class UCSBOrganizationIT {
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(get("/api/ucsborganization?orgcode=SWE"))
  ...
  public void an_admin_user_can_post_a_new_ucsborganization() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/ucsborganization/post?orgcode=SWE&orgTranslationShort=SWE&orgTranslation=Society of Women Engineers&inactive=false")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
