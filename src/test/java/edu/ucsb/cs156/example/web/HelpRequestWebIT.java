...
public class HelpRequestWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_help_request() throws Exception {
    ...
    page.getByTestId("HelpRequestForm-requesterEmail").fill("kham@ucsb.edu");
    page.getByTestId("HelpRequestForm-teamId").fill("f25-10");
    page.getByTestId("HelpRequestForm-tableOrBreakoutRoom").fill("Table 10");
    page.getByTestId("HelpRequestForm-requestTime").fill("2024-06-10T15:30");
    ...
    assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-explanation")).hasText("Help!");

    page.getByTestId("HelpRequestTable-cell-row-0-col-Edit-button").click();
    assertThat(page.getByText("Edit Help Request")).isVisible();
    page.getByTestId("HelpRequestForm-explanation").fill("Help please!");
    page.getByTestId("HelpRequestForm-submit").click();
